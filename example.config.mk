...
make-all-with-log:
	...
	set -o pipefail; \
	$(MAKE) all GO_TEST_FLAGS=-timeout=6m 2>&1 | tee $(or $(PROJECT_ROOT),$(error If you are reading this you specified the `file` option when calling `mcp-server-make`. DONT DO THAT.))/build.log | tail -n 15; \
	exit $${PIPESTATUS[0]}
