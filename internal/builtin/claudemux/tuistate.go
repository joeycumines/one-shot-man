...
// DefaultClaudeCodeTUIStateConfig returns the default configuration for
// detecting Claude Code TUI states.
func DefaultClaudeCodeTUIStateConfig() TUIStateMachineConfig {
