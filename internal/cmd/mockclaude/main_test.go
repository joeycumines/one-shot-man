...
// buildMock builds the mockclaude binary and returns its path.
func buildMock(t *testing.T) string {
	...
	bin := filepath.Join(t.TempDir(), "mockclaude")
...
func TestMockClaude_Protocol(t *testing.T) {
	skipSlow(t)
	bin := buildMock(t)
...
func TestMockClaude_RateLimit(t *testing.T) {
	skipSlow(t)
	bin := buildMock(t)
...
func TestMockClaude_Crash(t *testing.T) {
	skipSlow(t)
	bin := buildMock(t)
...
func TestMockClaude_Permission(t *testing.T) {
	skipSlow(t)
	bin := buildMock(t)
