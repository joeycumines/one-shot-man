...
func TestChunk15a_TUIConstantsStructure(t *testing.T) {
	...
	requiredKeys := []string{
		...
		"RESOLVE_POLL_MS", "AGENT_CHECK_POLL_MS", "AUTO_SPLIT_POLL_MS",
		"AGENT_SCREENSHOT_POLL_MS", "AGENT_ACTIVE_POLL_MS", "AGENT_IDLE_POLL_MS",
		"AGENT_OUTPUT_IDLE_MS", "AGENT_BELL_FLASH_MS",
