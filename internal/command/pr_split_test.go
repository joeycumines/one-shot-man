...
// ---------------------------------------------------------------------------
// T097: Conversation history round-trip persistence test
// ---------------------------------------------------------------------------
...
func TestResolveConflicts_RestoresBranchOnError(t *testing.T) {
	...
	val, err := evalJS(`(function() {
		...
		var result = resolveConflicts(plan, {
			verifyCommand: 'echo ok',
			retryBudget: 1,
			perBranchRetryBudget: 1
		});
...
// ---------------------------------------------------------------------------
// T110: AUTOMATED_DEFAULTS override chain
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// T127: maxReSplits negative validation
// ---------------------------------------------------------------------------
