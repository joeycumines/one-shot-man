...
function defaultTemplate() {
    // Use the embedded template content that's baked into the command
    // This replaces the previous fallback template with the content from prompt-flow-template.md
    return `!! N.B. only statements surrounded by "!!" are _instructions_. !!
